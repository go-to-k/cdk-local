 ...
 * symlinks kept VERBATIM (issue #727).
 *
 ...
 *     case. Measured by the go-to-k/cdkd#3118 review (the cdkd twin) on 22.23 / 24.15 /
 ...
 *
 * Both layer merges (`cdkl invoke` and `cdkl start-api`) call
