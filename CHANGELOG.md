...
v0.148.4 were generated by semantic-release, which released on every merge
to `main` before the switch to batched release PRs.

## [0.149.6](https://github.com/go-to-k/cdk-local/compare/v0.149.5...v0.149.6) (2026-09-24)


### Bug Fixes

* **local:** pull FIPS, dual-stack and ISO ECR images with a login to the pull host ([#766](https://github.com/go-to-k/cdk-local/issues/766)) ([c750b03](https://github.com/go-to-k/cdk-local/commit/c750b03385fbc2d465d923a8726ddd0ef679fae4))

## [0.149.5](https://github.com/go-to-k/cdk-local/compare/v0.149.4...v0.149.5) (2026-09-24)


### Bug Fixes

* **local:** render the docker-build failure's asset directory display-safe inside its parentheses ([#765](https://github.com/go-to-k/cdk-local/issues/765)) ([46f833c](https://github.com/go-to-k/cdk-local/commit/46f833cfb0ff48c9340c7afdf1f66d6ec8c2aad5))

## [0.149.4](https://github.com/go-to-k/cdk-local/compare/v0.149.3...v0.149.4) (2026-09-24)


### Bug Fixes

* **local:** render assembly-chosen values in refusals and warnings display-safe ([#762](https://github.com/go-to-k/cdk-local/issues/762)) ([3c325f0](https://github.com/go-to-k/cdk-local/commit/3c325f0f0f869c39d3eac6790ff6ec6424e5bc7d))

## [0.149.3](https://github.com/go-to-k/cdk-local/compare/v0.149.2...v0.149.3) (2026-09-24)


### Bug Fixes

* **local:** accept an absolute asset-manifest path outside the assembly with a warning ([#756](https://github.com/go-to-k/cdk-local/issues/756)) ([d734542](https://github.com/go-to-k/cdk-local/commit/d7345428ec020a16ca154623e155af904b7e1a01))
* **local:** contain the paths an asset manifest names before reading them ([#755](https://github.com/go-to-k/cdk-local/issues/755)) ([984dfc2](https://github.com/go-to-k/cdk-local/commit/984dfc261a2cdc358f482585afd7707b7098f79c))
* **local:** scope an accepted absolute CloudFront origin to a non-hidden project folder ([#757](https://github.com/go-to-k/cdk-local/issues/757)) ([ee00781](https://github.com/go-to-k/cdk-local/commit/ee00781f9ab638b2e0eeb41e68d106b620465ba8))
* **start-alb:** report a Lambda-target boot failure without the --lb-port hint ([#753](https://github.com/go-to-k/cdk-local/issues/753)) ([fa72ef8](https://github.com/go-to-k/cdk-local/commit/fa72ef8c86974e8854cc89e3489d0bef50fa89b0))

## [0.149.2](https://github.com/go-to-k/cdk-local/compare/v0.149.1...v0.149.2) (2026-09-24)


### Bug Fixes

* **local:** refuse to forward secrets under finch on macOS / Windows ([#750](https://github.com/go-to-k/cdk-local/issues/750)) ([19139c6](https://github.com/go-to-k/cdk-local/commit/19139c63b8fabb969cbf182924dcc3417c89f5d5))

## [0.149.1](https://github.com/go-to-k/cdk-local/compare/v0.149.0...v0.149.1) (2026-09-23)


### Bug Fixes

* **local:** warn before running a Docker asset's manifest-chosen source.executable ([#747](https://github.com/go-to-k/cdk-local/issues/747)) ([576cffb](https://github.com/go-to-k/cdk-local/commit/576cffba46411d40ead767f14166c7f7ca0bd556))

## [0.149.0](https://github.com/go-to-k/cdk-local/compare/v0.148.4...v0.149.0) (2026-09-22)


### ⚠ BREAKING CHANGES

* **deps:** raise the published Node.js floor from 20 to 22.12 across engines, the pack target, the CI matrix and the docs ([#729](https://github.com/go-to-k/cdk-local/issues/729))

### Bug Fixes

* **ci:** replace the step-if exemption predicate, which was inert on this tree ([#719](https://github.com/go-to-k/cdk-local/issues/719)) ([c5734c2](https://github.com/go-to-k/cdk-local/commit/c5734c23db3d803585c1c00664c3e212a18a7182))
* **deps:** bump commander to ^14.0.0, which now rejects extra command arguments instead of discarding them ([#723](https://github.com/go-to-k/cdk-local/issues/723)) ([f1547cc](https://github.com/go-to-k/cdk-local/commit/f1547cc582ce583523583900e3faca3eea80c550))
* **local:** contain the asset code path, and warn on an absolute escape ([#744](https://github.com/go-to-k/cdk-local/issues/744)) ([b78b093](https://github.com/go-to-k/cdk-local/commit/b78b093aba15714b1f904a31ae71637eff740a1c))
* **local:** copy a layer's symlinks verbatim, last-wins, so a relative link resolves inside the container ([#731](https://github.com/go-to-k/cdk-local/issues/731)) ([95e1a54](https://github.com/go-to-k/cdk-local/commit/95e1a547361e645ecc53fb133fce50d71c35a028))


### Miscellaneous Chores

* **deps:** raise the published Node.js floor from 20 to 22.12 across engines, the pack target, the CI matrix and the docs ([#729](https://github.com/go-to-k/cdk-local/issues/729)) ([e729f65](https://github.com/go-to-k/cdk-local/commit/e729f6535bc65e666f6aad9f50f84b68f6657b14))
