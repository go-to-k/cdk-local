...
Entries above this line were auto-generated by semantic-release, which released on each merge to `main` until the switch to release-please (batched releases).
