...
/**
 * Fixture for `cdkl start-service` Service Connect + Cloud Map
 ...
 * fixture stays small. `cdkl start-service` never makes AWS API
...
export class LocalEcsServiceConnectStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const ordersDiscovery = new cdk.aws_servicediscovery.CfnService(this, 'OrdersDiscovery', {
      ...
      // DnsConfig isn't read by cdkl — the in-process registry
