...
cdkl invoke-agent      # pick a Bedrock AgentCore Runtime, then invoke it
```
...
cdkl invoke-agent MyStack/ChatAgent --event ./event.json
```
...
| `AWS::BedrockAgentCore::Runtime` (invoke-agent, container artifact + HTTP) | ✓ |
